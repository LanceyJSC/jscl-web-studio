          ...
          <div className="relative">
            <div className="lg:sticky lg:top-32">
              ...
              <motion.p 
                ...
                className="text-lg md:text-xl text-muted-foreground font-light max-w-sm leading-relaxed"
              >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-y-10 gap-x-8">
                {[
                  ...
                  >
                    <h4 className="text-foreground font-bold mb-3 text-sm md:text-base tracking-wide uppercase">
                      {group.title}
                    </h4>
