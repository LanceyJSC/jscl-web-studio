            ...
            <div>
              ...
              <div className="overflow-hidden mb-4">
                <motion.h2 
                  ...
                  className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold leading-[0.9] tracking-tighter text-foreground"
                >
                  LET'S
                </motion.h2>
              </div>
              ...
              <motion.p 
                ...
                className="text-base md:text-lg text-muted-foreground font-light max-w-sm leading-relaxed mb-12 md:mb-16"
              >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-1">
                <label htmlFor="name" className="block text-xs font-mono font-bold uppercase text-muted-foreground">01 NAME</label>
                <input 
              ...
              <div className="space-y-1">
                <label htmlFor="email" className="block text-xs font-mono font-bold uppercase text-muted-foreground">02 EMAIL</label>
                <input 
              ...
              <div className="space-y-1">
                <label htmlFor="message" className="block text-xs font-mono font-bold uppercase text-muted-foreground">03 MESSAGE</label>
                <textarea 
